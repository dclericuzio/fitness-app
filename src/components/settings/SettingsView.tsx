    ...
    <div className="space-y-6">
      ...
      <section className="rounded-xl bg-card p-4">
        <h2 className="mb-3 flex items-center gap-2 text-sm font-semibold">
          <LinkIcon size={16} className="text-[#FC4C02]" />
          Strava
        </h2>
      ...
      <section className="rounded-xl bg-card p-4">
        ...
        <div className="space-y-3">
          {(
            Object.entries(categoryLabels) as [ExerciseCategory, string][]
          ).map(([cat, label]) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() =>
                      handleTimerChange(cat, Math.max(15, secs - 15))
                    }
                    className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 text-sm font-bold active:bg-white/20"
                  >
                    −
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleTimerChange(cat, Math.min(600, secs + 15))
                    }
                    className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 text-sm font-bold active:bg-white/20"
                  >
                    +
          ...
          {showAddSupplement ? (
            <div className="space-y-2 rounded-lg border border-white/10 p-3">
              <input
                ...
                className="w-full rounded-lg bg-white/10 px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-primary"
              />
              <div className="flex gap-2">
                <input
                  ...
                  value={newSupp.emoji}
                  onChange={(e) =>
                    setNewSupp({ ...newSupp, emoji: e.target.value })
                  }
                  className="w-16 rounded-lg bg-white/10 px-3 py-2 text-center text-sm outline-none focus:ring-1 focus:ring-primary"
                />
                <select
                  ...
                  onChange={(e) =>
                    setNewSupp({
                      ...newSupp,
                      timeOfDay: e.target.value as SupplementTime,
                    })
                  }
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-white/10 px-3 py-2 text-sm text-muted"
                >
                  Cancel
                </button>
              </div>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-1 rounded-lg border border-dashed border-white/10 py-2 text-xs text-muted transition-colors hover:border-white/20"
            >
      ...
      <section className="rounded-xl bg-card p-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-white/10 py-2.5 text-sm font-medium transition-all active:bg-white/20"
          >
